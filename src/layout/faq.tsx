...
// import { FAQ_ITEMS } from '../service/faqServices';
...
//     isOpen: boolean;
//     onClose: () => void;
//     onSendMessage: (title: string, id: number) => void; // 변경: title + id
// }

// const FAQ: React.FC<FAQProps> = ({ isOpen, onClose, onSendMessage }) => {
